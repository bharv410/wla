...
public class Connect {
	...
	public User loginUser(String username, String password) {
        ...
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/login", parameters);
		try {
	...
	public User registerUser(String username, String password, String email, Bitmap userAvatar, int userType, String fullName, String info, double latitude, double longitude, String companyAddress, String companyPhone, String companyWeb) {
		...
		HttpPost httpPost = new HttpPost("http://fitovate.elasticbeanstalk.com/register");
		httpPost.addHeader("api_key", "qwertyuiop");
		...
		try {
	        ...
	        if (jsonObject != null && jsonObject.has("item")) {
	        	...
	        	System.out.println("mustve been null");
	        }
	...
	public User updateUser(int userID, String email, Bitmap userAvatar, int userType, String fullName, String info, double latitude, double longitude, String companyAddress, String companyPhone, String companyWeb) {
		...
		HttpPost httpPost = new HttpPost("http://fitovate.elasticbeanstalk.com/setProfile");
	...
	public User getUser(int userID) {
        ...
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/getProfile", parameters);
		try {
	...
	public ArrayList<Post> getTimeline(int userID, int page, int pageSize) {
        ...
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/getTimeline", parameters);
	...
	public ArrayList<Post> getPopular(int page, int pageSize) {
		...
		parameters.add(new BasicNameValuePair("take", String.valueOf(pageSize)));
		ArrayList<Post> posts = new ArrayList<Post>();
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/getPopularPosts", parameters);
		if (jsonObject != null && jsonObject.has("items")) {
        	JSONArray jsonArray;
			try {
				jsonArray = jsonObject.getJSONArray("items");
	...
	public ArrayList<Post> getRecent(int page, int pageSize) {
		...
		parameters.add(new BasicNameValuePair("take", String.valueOf(pageSize)));
		ArrayList<Post> posts = new ArrayList<Post>();
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/getRecentPosts", parameters);
		if (jsonObject != null && jsonObject.has("items")) {
        	JSONArray jsonArray;
			try {
				jsonArray = jsonObject.getJSONArray("items");
	...
	public ArrayList<Comment> getComments(int postID, int page, int pageSize) {
        ...
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/getComments", parameters);
		if (jsonObject != null && jsonObject.has("items")) {
        	JSONArray jsonArray;
			try {
				jsonArray = jsonObject.getJSONArray("items");
	...
	public Comment sendComment(int postID, String commentText) {
        ...
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/setComment", parameters);
		if (jsonObject != null && jsonObject.has("item")) {
	...
	public boolean removeComment(int commentID) {
        ...
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/removeComment", parameters);
	...
	public ArrayList<Like> getLikes(int postID, int page, int pageSize) {
        ...
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/getLikes", parameters);
		if (jsonObject != null && jsonObject.has("items")) {
        	JSONArray jsonArray;
			try {
				jsonArray = jsonObject.getJSONArray("items");
	...
	public boolean likePost(int postID) {
		...
		parameters.add(new BasicNameValuePair("userID", String.valueOf(mCurrentUser.userID)));
		parameters.add(new BasicNameValuePair("postID", String.valueOf(postID)));
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/setLike", parameters);
		if (jsonObject != null && jsonObject.has("item")) {
        	return true;
        } else {
        	return false;
	...
	public boolean unlikePost(int postID) {
		...
		parameters.add(new BasicNameValuePair("userID", String.valueOf(mCurrentUser.userID)));
		parameters.add(new BasicNameValuePair("postID", String.valueOf(postID)));
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/removeLike", parameters);
		if (jsonObject != null && jsonObject.has("status") && BaseObject.getStringFromJSONObject(jsonObject, "status").equals("OK")) {
        	return true;
        } else {
        	return false;
	...
	public ArrayList<User> getFollowers(int userID, int page, int pageSize) {
        ...
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/getFollowers", parameters);
		if (jsonObject != null && jsonObject.has("items")) {
        	JSONArray jsonArray;
			try {
				jsonArray = jsonObject.getJSONArray("items");
	...
	public ArrayList<User> getFollowing(int userID, int page, int pageSize) {
		...
		parameters.add(new BasicNameValuePair("take", String.valueOf(pageSize)));
		ArrayList<User> users = new ArrayList<User>();
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/getFollowing", parameters);
		if (jsonObject != null && jsonObject.has("items")) {
        	JSONArray jsonArray;
			try {
				jsonArray = jsonObject.getJSONArray("items");
	...
	public boolean followUser(int userID) {
        ...
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/setFollow", parameters);
		if (jsonObject != null && jsonObject.has("item")) {
        	return true;
        } else {
        	return false;
	...
	public boolean unfollowUser(int followID) {
        ...
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/removeFollow", parameters);
		if (jsonObject != null && jsonObject.has("status") && BaseObject.getStringFromJSONObject(jsonObject, "status").equals("OK")) {
        	return true;
        } else {
        	return false;
	...
	public ArrayList<User> getUsersForString(String query, int page, int pageSize) {
		...
		ArrayList<User> users = new ArrayList<User>();
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/findUsers", parameters);
		if (jsonObject != null && jsonObject.has("items")) {
        	JSONArray jsonArray;
			try {
				jsonArray = jsonObject.getJSONArray("items");
	...
	public ArrayList<User> getUsersAround(double latitude, double longitude, double distance, int page, int pageSize) {
		...
		parameters.add(new BasicNameValuePair("take", String.valueOf(pageSize)));
		ArrayList<User> users = new ArrayList<User>();
        JSONObject jsonObject = this.getJSONObject("http://fitovate.elasticbeanstalk.com/getLocationsForLatLong", parameters);
		if (jsonObject != null && jsonObject.has("items")) {
        	JSONArray jsonArray;
			try {
				jsonArray = jsonObject.getJSONArray("items");
	...
	public Post sendPost(String postTitle, Bitmap postImage) {
		...
		HttpPost httpPost = new HttpPost("http://fitovate.elasticbeanstalk.com/sendPost");
		httpPost.addHeader("api_key", "!#wli!sdWQDScxzczFžŽYewQsq_?wdX09612627364[3072∑34260-#");
		HttpResponse response = null;
		try {
			httpPost.setEntity(mpEntity.build());
