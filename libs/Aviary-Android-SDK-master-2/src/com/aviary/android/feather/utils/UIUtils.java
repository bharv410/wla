...
public class UIUtils {
	...
	/**
	 * @see #makeCustomToast(android.content.Context, int)
	 */
	...
	/**
	 * Creates a custom {@link android.widget.Toast} with a custom layout View
	 * 
	 * @param context
	 *            the context
	 * @param resId
	 *            the custom view
	 * @return the created {@link android.widget.Toast}
	 */
