...
public class AdjustImageView extends View {
	...
	public enum ScaleType {
		 ...
		 * {@link android.widget.ImageView#setImageMatrix(android.graphics.Matrix)}. From
		 * XML, use this syntax: <code>android:scaleType="matrix"</code>.
		 */
		MATRIX ( 0 ),
		/**
		 * Scale the image using {@link android.graphics.Matrix.ScaleToFit#FILL}. From XML, use this
		 * syntax: <code>android:scaleType="fitXY"</code>.
		 */
		FIT_XY ( 1 ),
		/**
		 * Scale the image using {@link android.graphics.Matrix.ScaleToFit#START}. From XML, use this
		 * syntax: <code>android:scaleType="fitStart"</code> .
		 */
		FIT_START ( 2 ),
		/**
		 * Scale the image using {@link android.graphics.Matrix.ScaleToFit#CENTER}. From XML, use this
		 * syntax: <code>android:scaleType="fitCenter"</code>.
		 */
		FIT_CENTER ( 3 ),
		/**
		 * Scale the image using {@link android.graphics.Matrix.ScaleToFit#END}. From XML, use this syntax:
