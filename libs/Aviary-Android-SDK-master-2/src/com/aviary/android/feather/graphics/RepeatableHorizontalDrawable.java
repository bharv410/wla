...
public class RepeatableHorizontalDrawable extends Drawable {
	...
	/**
	 * Construct a new {@link com.aviary.android.feather.graphics.RepeatableHorizontalDrawable} instance.
	 * 
	 * @param resources
	 *            the current Context {@link android.content.res.Resources} used to extract the resource
	 * @param resId
	 *            the {@link android.graphics.drawable.BitmapDrawable} resource used to draw
	 */
